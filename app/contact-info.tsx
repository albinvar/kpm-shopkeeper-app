...
export default function ContactInfoScreen() {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      >
        <View className="mb-6">
          <Text className="text-gray-700 font-semibold text-base mb-2">Phone Number</Text>
          ...
          <Text className="text-gray-400 text-xs mt-1">Format: +91XXXXXXXXXX or 10 digits</Text>
        </View>

        <View className="mb-6">
          <Text className="text-gray-700 font-semibold text-base mb-2">Email Address</Text>
          <View className="bg-white rounded-xl px-4 py-3 border border-gray-200 flex-row items-center">
        ...
        <View className="mb-6">
          <Text className="text-gray-700 font-semibold text-base mb-2">Website</Text>
          <View className="bg-white rounded-xl px-4 py-3 border border-gray-200 flex-row items-center">
          ...
          <Text className="text-gray-400 text-xs mt-1">Include http:// or https://</Text>
        </View>

        <View className="mb-6">
          <Text className="text-gray-700 font-semibold text-base mb-2">WhatsApp Number</Text>
          <View className="bg-white rounded-xl px-4 py-3 border border-gray-200 flex-row items-center">
          ...
          <Text className="text-gray-400 text-xs mt-1">Customers can contact you via WhatsApp</Text>
        </View>

        <View className="bg-blue-50 rounded-xl p-4 mb-6 flex-row">
          <Ionicons name="information-circle" size={20} color="#3b82f6" />
          <View className="flex-1 ml-3">
            <Text className="text-blue-900 font-medium text-sm mb-1">Contact Privacy</Text>
