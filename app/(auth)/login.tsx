    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Rising Bottom Section with Rounded Corners */}
          <Animated.View 
            entering={FadeInUp.delay(300).springify()}
            className="bg-white shadow-xl rounded-t-[48px] px-6 pt-8"
            style={{
              shadowColor: "#000",
          ...
          >
            ...
            {/* Phone Input Section */}
            <View className="mb-5" style={{ minHeight: 70 }}>
              ...
              {phoneNumber && !isValidPhone && (
                <Text className="text-red-500 text-xs mt-2 ml-2 absolute" style={{ top: 60 }}>
